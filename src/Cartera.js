                            ...
                            return fila.Cliente.Referencias.map(referencia => {
                                return(
                                    <tr key={fila.idReferencia}>
                                        ...
                                        <td>{fila.cuota == 'null' ? '' : (new Intl.NumberFormat("en-IN", {style: "currency", currency: "MXN"}).format(fila.cuota))}</td>
                                        <td>{fila.mejora == 'null' ? '' : (new Intl.NumberFormat("en-IN", {style: "currency", currency: "MXN"}).format(fila.mejora))}</td>
                                        <td>{fila.cura == 'null' ? '' : (new Intl.NumberFormat("en-IN", {style: "currency", currency: "MXN"}).format(fila.cura))}</td>
                                        <td>{fila.sdoTotal == 'null' ? '' : (new Intl.NumberFormat("en-IN", {style: "currency", currency: "MXN"}).format(fila.sdoTotal))}</td>
                                        <td>{fila.sdoLiq == 'null' ? '' : (new Intl.NumberFormat("en-IN", {style: "currency", currency: "MXN"}).format(fila.sdoLiq))}</td>
